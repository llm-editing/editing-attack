...
class IKEHyperParams(HyperParams):
    ...
    gpt_eval_endpoint_default: bool = True
    gpt_eval_name_default: bool = True
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and (config['alg_name'] == 'IKE' or config['alg_name'] == 'ICL')) or print(f'IKEHyperParams can not load from {hparams_name_or_path}, '

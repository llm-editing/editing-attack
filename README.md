...
- **Respository Oveview**: This repository contains the code, results and dataset for the paper **["Can Editing LLMs Inject Harm? [AAAI'26]"](https://arxiv.org/abs/2407.20224)**
...
<img src="./data/intro.png" width=85%>
